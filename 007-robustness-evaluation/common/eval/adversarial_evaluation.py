...
class AdversarialEvaluation:
    ...
    def __init__(self, clean_probabilities, adversarial_probabilities, labels, validation=0.1, errors=None):
        """
        Constructor.

        Sets up confidence-thresholded (robust) test error evaluation and related metrics. To this end,
        a part of the examples, controlled by `validation` is set aside as a validation set.
